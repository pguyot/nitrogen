...
new_textarea_1() ->
    ...
    iolist_to_binary(element_textarea:render("1",Rec_textarea)).

new_textarea_2() ->
    Rec_textarea = #textarea{class="t_textarea"},
    iolist_to_binary(element_textarea:render("2",Rec_textarea)).

new_textarea_3() ->
    Rec_textarea = #textarea{class="t_textarea", style="color: cyan;", text="TEXT"},
    iolist_to_binary(element_textarea:render("3",Rec_textarea)).
