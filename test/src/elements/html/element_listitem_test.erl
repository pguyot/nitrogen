...
new_listitem_1() ->
    ...
    iolist_to_binary(element_listitem:render("1",Rec_listitem)).

new_listitem_2() ->
    Rec_listitem = #listitem{class="t_listitem"},
    iolist_to_binary(element_listitem:render("2",Rec_listitem)).

new_listitem_3() ->
    Rec_listitem = #listitem{class="t_listitem", style="color: cyan;", text="http://an_listitem.com/sample/listitem.jpg"},
    iolist_to_binary(element_listitem:render("3",Rec_listitem)).
