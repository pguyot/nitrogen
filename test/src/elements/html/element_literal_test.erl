...
new_literal_1() ->
    Rec_literal = #literal{},
    iolist_to_binary(element_literal:render("1",Rec_literal)).  % the value does nothing

new_literal_2() ->
    Rec_literal = #literal{class="t_literal"},
    iolist_to_binary(element_literal:render("2",Rec_literal)).

new_literal_3() ->
    Rec_literal = #literal{class="t_literal", style="color: cyan;", text="http://an_literal.com/sample/literal.jpg"},
    iolist_to_binary(element_literal:render("3",Rec_literal)).
